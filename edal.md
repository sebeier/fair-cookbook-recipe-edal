# Publishing Plant Research Data via the e!DAL-PGP Repository

````{panels_fairplus}
:identifier_text: FCB099
:identifier_link: '[https://w3id.org/faircookbook/FCB099](https://w3id.org/faircookbook/FCB099)'
:difficulty_level: 2
...
This recipe guides users through the specific steps of the e!DAL submission wizard, moving from basic metadata provision to creator management and finally data upload.

The main objective is to maximize the **Findability** and **Reusability** of the data by:
1.  Providing rich descriptive metadata (Titles, Abstracts).
2.  Uniquely identifying contributors via ORCIDs and RORs.
3.  Ensuring data integrity during the upload process.
...
### Step 1: Provide Basic Dataset Information

Upon initiating the wizard, the first major step (Step 2 of 4) requires defining the core identity of the dataset.
...
### Step 2: Add Creator Information and Affiliations
...
Once the files are listed in the table and verified:
1.  Click the **Finish** button.
2.  The system will generate a review summary.
3.  Upon final confirmation, the dataset is locked for internal review and DOI registration.

## Conclusion

By following these steps, you ensure that your dataset is not only stored safely but is also semantically rich. 
